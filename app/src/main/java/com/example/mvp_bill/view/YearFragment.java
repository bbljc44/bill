...
public class YearFragment extends Fragment implements AnalysisView{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.year_fragment, container, false);
        initView();
        return view;
    }
    ...
    private void initView(){
        ...
        viewStub = view.findViewById(R.id.year_vs);
        viewStub.inflate();
        viewStub.setVisibility(View.GONE);
        SwipeRefreshLayout refreshLayout = view.findViewById(R.id.year_refresh);
        refreshLayout.setColorSchemeResources(R.color.colorPrimary);
        refreshLayout.setOnRefreshListener(() -> {
            presenter.sendGetDuration("year", userName, category);
    ...
    private void init() {
        ...
        PieChart pieChart = view.findViewById(R.id.year_pc);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.year_rv);
